(() => {
  const translations = {
    en: {
      ...
      hero_cta: 'Install UxNote (v1.0.0)',
    ...
    fr: {
      ...
      hero_cta: 'Installer UxNote (v1.0.0)',
      ...
      github_releases: 'Voir les versions',
      faq_title: 'FAQ',
