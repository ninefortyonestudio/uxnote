(() => {
  const translations = {
    en: {
      ...
      github_body: 'Uxnote is source-available on GitHub. You may use and modify it for noncommercial purposes; selling or commercial redistribution is not allowed.',
      ...
      faq_a6b: 'Uxnote is source-available: you are free to use and modify it for personal or internal projects, but resale or commercial redistribution is not allowed. That makes it more restrictive than OSI open source.',
    ...
    fr: {
      ...
      github_body: 'Uxnote est en source disponible sur GitHub. Vous pouvez l’utiliser et le modifier à des fins non commerciales ; la vente ou redistribution commerciale est interdite.',
      ...
      faq_a6b: 'Uxnote est en source disponible : vous pouvez l’utiliser et le modifier pour un usage personnel ou interne, mais la revente ou redistribution commerciale n’est pas autorisée. C’est donc plus restrictif qu’un open source OSI.',
